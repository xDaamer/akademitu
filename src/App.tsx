...
export default function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans selection:bg-[#B6D6CC] selection:text-[#191F61]">
      ...
      {/* 5. SOL TARAF: ARAYALIM BUTONU (SABIT) */}
      <button
        onClick={handleOpenTrialForm}
        className="fixed left-0 top-1/2 -translate-y-1/2 bg-[#191F61] hover:bg-[#0f1436] text-white px-3 py-8 rounded-r-2xl shadow-lg transition-all duration-300 z-40 group hidden sm:flex flex-col items-center justify-center gap-2"
      >
      ...
      <div className="fixed bottom-6 right-6 z-40">
        <button
          ...
          className="bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg transition-all duration-300 transform hover:scale-110 active:scale-95"
        >
