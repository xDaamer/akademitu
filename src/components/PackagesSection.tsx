    ...
    <section id="paketler" className="py-16 sm:py-24 bg-slate-50 relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch max-w-4xl mx-auto">
          ...
          <div className="bg-[#191F61] text-white rounded-3xl p-8 border-2 border-[#c5a059] shadow-2xl flex flex-col justify-between relative transform lg:-translate-y-3 z-10">
            {/* POPÜLER ROZETİ */}
