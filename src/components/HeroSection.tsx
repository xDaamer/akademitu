...
export const HeroSection: React.FC<HeroSectionProps> = ({ onOpenTrialForm }) => {
  return (
    <section id="ana-sayfa" className="py-8 sm:py-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
      ...
      <div className="bg-[#191F61] rounded-3xl sm:rounded-[2.5rem] p-6 sm:p-10 lg:p-14 text-white shadow-2xl relative overflow-hidden border border-[#191F61]/50">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-8 lg:gap-12 items-center relative z-10">
          ...
          <div className="relative h-[360px] sm:h-[400px] md:h-[440px] lg:h-[480px] overflow-hidden rounded-2xl sm:rounded-3xl bg-white/5 backdrop-blur-md border border-white/15 p-3 sm:p-4 shadow-2xl">
            <TeacherTicker />
          </div>
